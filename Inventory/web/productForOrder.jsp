...
//                window.location.href="http://localhost:8080/Inventory/AddProductToCart?productId="+pid+"&quantity="+qty;
    ...
    <body>
        ...
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            ...
            <div class="navbar-nav">
                <div class="nav-item text-nowrap">
                    <a class="nav-link px-3" href="ViewCartServlet"><i class="fa" style="font-size:24px">&#xf07a; <span id="result"></span></i></a>
                </div>
            </div>
            <div class="navbar-nav">
                <div class="nav-item text-nowrap">
                        ...
                        <table class="table table-striped table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">product Make</th>                                   <th scope="col">Availability</th>
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${Product}" var="product">
                                    <tr>
                                        ...
                                        <td>${product.getProductMake()}</td>
                                        <td>${product.getAvaility()}</td>

                                        <td>
                                            <input type="text" id='quantity_${product.getProductId()}' value="">

                                        </td>
                                        <td>
                                            <input type="button" value="Add to cart" onclick="addProductToCart(${product.getProductId()})">
