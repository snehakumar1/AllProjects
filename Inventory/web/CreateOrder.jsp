        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <h2>Create Order</h2>
                    <form action="PlaceNewOrderServlet" method="post">
                            ...
                            <table class="table table-striped table-sm">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="date" value="" name="orderDate"> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="col">Customer Name</th>
                                        <td>
                                            <select name="customerName" size="7" multiple="multiple">
                                                <c:forEach items="${customer}" var="customer">
                                                <option value='<c:out value="${customer.getCustomer_name()}"/>'><c:out value="${customer.getCustomer_name()}"/></option>
